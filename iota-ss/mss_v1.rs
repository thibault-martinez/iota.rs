    ...
    fn mss_v1_kerl_sec_1_test() {
        ...
        let public_key =
            MssV1PublicKey::<Kerl, WotsV1PublicKey<Kerl>>::from_bytes(&PUBLIC_KEY.trits())
                .depth(DEPTH);
        let signature = MssV1Signature::<Kerl>::from_bytes(&SIGNATURE.trits()).index(INDEX);
